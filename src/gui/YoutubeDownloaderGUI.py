...
from interface.YoutubeMusicInterface import DownloaderInterface # type: ignore
...
class YoutubeMusicGUI:
    ...
    class SidebarWidget(QWidget):
        ...
        def setup_ui(self):
            ...
            for img_path, tooltip, page_idx in button_data:
                btn = YoutubeMusicGUI.ImageButton(img_path, tooltip)
    ...
    class MainWindow(QMainWindow):
        def __init__(self):
            ...
            self.current_worker: Optional[YoutubeMusicGUI.DownloadWorker] = None
            self.log_entries: List[YoutubeMusicGUI.LogEntry] = []
        ...
        def init_ui(self):
            ...
            self.sidebar = YoutubeMusicGUI.SidebarWidget()
        ...
        def open_downloads_folder(self):
            ...
            output_dir = self.downloader._YoutubeMusicDownloader__output_directory
        ...
        def refresh_settings_display(self):
            self.format_combo.setCurrentText(self.downloader._YoutubeMusicDownloader__audio_format)
            self.quality_combo.setCurrentText(self.downloader._YoutubeMusicDownloader__audio_quality)
            self.output_dir_edit.setText(str(self.downloader._YoutubeMusicDownloader__output_directory))
            self.metadata_check.setChecked(self.downloader._YoutubeMusicDownloader__embed_metadata)
        ...
        def save_settings(self):
            self.downloader._YoutubeMusicDownloader__audio_format = self.format_combo.currentText()
            self.downloader._YoutubeMusicDownloader__audio_quality = self.quality_combo.currentText()
            self.downloader._YoutubeMusicDownloader__output_directory = Path(self.output_dir_edit.text())
            self.downloader._YoutubeMusicDownloader__embed_metadata = self.metadata_check.isChecked()
        ...
        def append_log(self, message: str, level: str):
            entry = YoutubeMusicGUI.LogEntry(message, level)
        ...
        def start_download(self):
            ...
            self.current_worker = YoutubeMusicGUI.DownloadWorker(
